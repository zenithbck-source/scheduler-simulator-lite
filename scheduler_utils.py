...
def simulate_sjf(jobs, total_cores):
    jobs = sorted(jobs, key=lambda job: job['runtime'])  # lower submit_time means earlier submission
    scheduled_jobs = []
    schedule = []
    avail_cores = total_cores
    current_time = 1
